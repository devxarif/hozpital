...
use App\Http\Controllers\Patient\BloodDonorController;
...
Route::middleware(['auth'])->name('patient.')->prefix('patient')->group(function () {
    // // Department Routes
    ...
    // Blood
    Route::get('bloodDonor', [BloodDonorController::class, 'index'])->name('bloodDonor.index');
