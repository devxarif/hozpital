    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                email: this.organization.organization_email,
                avatar: null,
                country: this.company ? this.organization.country_id : "",
            }),

            previewImage: this.organization.organization_logo,
        };
    },
    methods: {
        async changeTab(tab) {
        ...
        profileUpdate() {
            this.form.post(route("organization.general.setting.update"),{
        ...
        deleteCompany() {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete(route("organization.delete"), {
                        onSuccess: () => window.location.reload()
                    });
                }
            });
    ...
    watch: {
        user: {
            handler() {
                ...
                this.form.email = this.organization.organization_email;
                this.form.avatar = this.organization.organization_logo;
                this.previewImage = this.organization.organization_logo;
            },
            deep: true,
        },
    },
