<template>
     <header class="z-30 py-4 bg-white shadow-md dark:bg-gray-800">
        <div
            class="container-fluid flex items-center justify-between h-full px-6 mx-auto text-gray-500 dark:text-gray-500">
            ...
            <a class="flex text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-10">
                <li class="relative">
                    <button @click="toggleOrganization = !toggleOrganization" id="dropdownDefault" data-dropdown-toggle="dropdown" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Kodebazar's Organization <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
