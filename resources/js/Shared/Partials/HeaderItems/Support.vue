<template>
  <Popover v-slot="{ open }" class="relative">
      <PopoverButton
        ...
        class="group inline-flex items-center px-3 py-2 text-base font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
      >
        <!-- <span>Solutions</span>
        <ChevronDownIcon
