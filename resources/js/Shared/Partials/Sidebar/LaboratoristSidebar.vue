        ...
        <div class="flex min-h-0 flex-1 flex-col bg-slate-800">
          <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            ...
            <nav class="mt-5 flex-1 space-y-1 px-2">
                  ...
                  <DropdownMenu title="Blood Bank" :active="route().current('laboratorist.bloodBank.index') || route().current('laboratorist.bloodDonor.index') || route().current('laboratorist.bloodDonation.index') ">
                    <template v-slot:icon>
                    ...
                    <DropdownMenuItem title="Blood Bank" :href="route('laboratorist.bloodBank.index')" :active="route().current('laboratorist.bloodBank.index')"/>
                    <DropdownMenuItem title="Blood Donor" :href="route('laboratorist.bloodDonor.index')" :active="route().current('laboratorist.bloodDonor.index')"/>
                    <DropdownMenuItem title="Blood Donation" :href="route('laboratorist.bloodDonation.index')" :active="route().current('laboratorist.bloodDonation.index')"/>
                </DropdownMenu>
