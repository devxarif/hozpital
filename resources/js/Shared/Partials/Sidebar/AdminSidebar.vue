      ...
      <div class="flex min-h-0 flex-1 flex-col bg-slate-800">
        <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
          ...
          <nav class="mt-5 flex-1 space-y-1 px-2">
                ...
                <!-- Finance  -->
                <DropdownMenu title="Finance & Billing" :active="route().current('admin.bloodBank.index') || route().current('admin.bloodDonor.index') || route().current('admin.bloodDonation.index') ">
                    <template v-slot:icon>
                    ...
                    <DropdownMenuItem title="Income List" :href="route('admin.income.index')" :active="false"/>
