        ...
        <div class="card-body">
            <form @submit.prevent="updateData">
                <div class="form-group">
                    <Label :name="__('Midtrans ID')" />
                    <input v-model="form.midtrans_id" type="text" class="form-control" :class="{'is-invalid':form.errors.midtrans_id}">
                    <ErrorMessage :name="form.errors.midtrans_id" />
                </div>
                <div class="form-group">
                    <Label :name="__('Midtrans Key')" />
                    <input v-model="form.midtrans_key" type="text" class="form-control" :class="{'is-invalid':form.errors.midtrans_key}">
                    <ErrorMessage :name="form.errors.midtrans_key" />
                </div>
                <div class="form-group">
                    <Label :name="__('Midtrans Secret')" />
                    <input v-model="form.midtrans_secret" type="text" class="form-control" :class="{'is-invalid':form.errors.midtrans_secret}">
                    <ErrorMessage :name="form.errors.midtrans_secret" />
                </div>
                 <div class="form-group">
                    <Label :name="__('Midtrans Status')" />
                    <div>
                         <label class="switch ">
                        <input @change="statusChange" v-model="form.midtrans_active" type="checkbox" class="success toggle-switch" :checked="form.midtrans_active">
