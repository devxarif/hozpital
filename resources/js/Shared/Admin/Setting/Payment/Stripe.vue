        ...
        <div class="card-body">
            <form @submit.prevent="updateData">
                <div class="form-group">
                    <Label :name="__('Stripe Key')" />
                    <input v-model="form.stripe_key" type="text" class="form-control" :class="{'is-invalid':form.errors.stripe_key}">
                    <ErrorMessage :name="form.errors.stripe_key" />
                </div>
                <div class="form-group">
                    <Label :name="__('Stripe Secret')" />
                    <input v-model="form.stripe_secret" type="text" class="form-control" :class="{'is-invalid':form.errors.stripe_secret}">
                 ...
                 <div class="form-group">
                    ...
                    <div>
                         <label class="switch ">
                        <input @change="statusChange" v-model="form.stripe_active" type="checkbox" class="success toggle-switch" :checked="form.stripe_active">
