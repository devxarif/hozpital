                            ...
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                ...
                                <form class="mb-4" @submit.prevent="updateData">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="mb-4">
                                            <Label :name="__('Leave Balance Day')" :hasError="form.errors.type"/>
                                            <input type="number" min="1" id="id" class="bg-gray-50 border text-md rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <label for="checked-toggle" class="inline-flex relative items-center cursor-pointer">
                                                <input v-model="form.status" @change="statusChange" type="checkbox" id="checked-toggle" class="sr-only peer" :checked="form.status">
...
export default {
    ...
    methods: {
        updateData() {
            console.log(4654)
            this.form.put(route("organization.leaveTypes.update", this.leaveType.id), {
                onSuccess: () => {
                    this.form.reset(),
