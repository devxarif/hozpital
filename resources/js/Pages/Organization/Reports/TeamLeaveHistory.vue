     ...
     <div class="row justify-content-center pt-5">
        <div class="col-lg-2">
            <div class="form-group">
                ...
                <span v-if="errors.team" class="invalid-feedback">{{ errors.team && errors.team[0] }}</span>
            </div>
        </div>
        <div class="col-lg-2">
            <div class="form-group">
            ...
            <div class="card">
                  <div class="card-header">
                     <div class="d-flex justify-content-between">
                        <h3 class="card-title">{{ __('Team Leave History') }}</h3>
    ...
    methods: {
        ...
        async getReport(){
            try {
                ...
                this.errors = {}
                let response = await axios.get(route('organization.reports.team.leave.history.report'), {
                    params: {
                        team: this.form.team,
