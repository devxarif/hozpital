            ...
            <div class="page-content page-min-height">
                <div class="transition-all duration-150 container-fluid">
                    ...
                    <div class="space-y-5 profile-page">
                        <div
                            class="profiel-wrap px-[35px] pb-10 md:pt-10 rounded-lg bg-white lg:flex lg:space-y-0 space-y-6 justify-between items-end relative z-[1]">
                                ...
                                <div class="md:flex items-end md:space-x-6 rtl:space-x-reverse gap-3">
                                    <div class="flex-none">
                                        <div
                                            ...
                                            <img src="https://dashcode.codeshaper.net/assets/user-1-ad58ce72.jpg" alt=""
                                    ...
                                    <div class="flex-1">
                                        <div class="text-2xl font-medium text-slate-900 ">
                                            Albert Flores </div>
                                        <div class="text-sm font-light text-slate-600"> Front End
                                            Developer </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-text h-full">
                                            <ul class="list space-y-8">
                                                <li class="flex space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    <div class="flex-1">
                                                        <div
                                                            class="uppercase text-xs text-slate-500 mb-1 leading-[12px]">
                                                            EMAIL </div><a href="mailto:someone@example.com"
                                                            class="text-base text-slate-600 ">
                                                            info-500@dashcode.com </a>
                                                    </div>
                                                </li>
                                                <li class="flex space-x-3 rtl:space-x-reverse">
                                                    <div class="flex-none text-2xl text-slate-600">
                                                    ...
                                                    <div class="flex-1">
                                                        <div
                                                            class="uppercase text-xs text-slate-500 mb-1 leading-[12px]">
                                                            PHONE </div><a href="tel:0189749676767"
                                                            class="text-base text-slate-600">
                                                            +1-202-555-0151 </a>
                                                    </div>
                                                </li>
