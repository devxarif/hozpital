...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                description: this.income_category.description,
                _method: 'PUT'
            }),
        };
    },
    watch: {
        income_category: {
            handler() {
                this.form.name = this.income_category.name
                this.form.description = this.income_category.description
            },
            deep: true,
        },
    },
    methods: {
        saveData() {
            this.form.post(route("admin.incomeCategory.update", this.income_category.id), {
                onSuccess: () => {
                    this.form.reset(),
