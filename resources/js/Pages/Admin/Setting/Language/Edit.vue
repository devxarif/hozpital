                                ...
                                <form class="mb-4" @submit.prevent="saveData">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                                            ...
                                            <div class="relative flex items-center border-2 rounded p-3 h-11 border-gray-200 dark:border-zinc-700 focus:ring-primary-600 focus:border-primary-600">
                                                <div class="flex items-center h-5">
                                                    <input :checked="language.status" v-model="form.status" value="1" id="status_language" type="checkbox" class="focus:ring-primary-600 h-4 w-4 text-primary-600 border-gray-300 rounded" wire:model.defer="is_active">
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative flex items-center border-2 rounded p-3 h-11 border-gray-200 dark:border-zinc-700 focus:ring-primary-600 focus:border-primary-600">
                                                <div class="flex items-center h-5">
                                                    <input :checked="language.force_rtl" v-model="form.force_rtl" value="1" id="rtl_direction" type="checkbox" class="focus:ring-primary-600 h-4 w-4 text-primary-600 border-gray-300 rounded">
                                                </div>
                                                <div class="ml-2 text-xs">
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                status: this.language.status ? true : false,
                force_rtl: this.language.force_rtl ? true : false,
                _method: 'PUT'
            })
        };
    },
    methods: {
        saveData() {
            this.form.post(route("admin.settings.languages.update", this.language.id), {
                onSuccess: () => {
                    this.form.reset(),
