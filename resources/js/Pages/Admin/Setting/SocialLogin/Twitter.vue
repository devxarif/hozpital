        ...
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="space-y-6 sm:space-y-5">
                ...
                <div class="space-y-6 sm:space-y-5">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                        <Label name="Client Secret" id="twitter_secret" :hasError="form.errors.twitter_secret"/>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                            <div class="max-w-lg rounded-md shadow-sm">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                        <Label name="Status" id="twitter_active" :hasError="form.errors.twitter_active"/>
                        <div class="mt-1 sm:col-span-2 sm:mt-0">
                            <label for="twitter_status" class="inline-flex relative items-center cursor-pointer">
                                <input @change="statusChange" v-model="form.twitter_active" type="checkbox" id="twitter_status" class="sr-only peer" :checked="form.twitter_active">
                                <div
