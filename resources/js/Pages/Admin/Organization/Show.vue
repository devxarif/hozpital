            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img :src="user.organization_logo" alt="logo" class="rounded-circle object-fit-cover" width="150" height="150">
                        <div class="mt-3">
        ...
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <hr>
                    <template v-if="user.company && user.organization.country">
                        <div class="row">
                            <div class="col-sm-3">
                ...
                switch (value) {
                    case 'order':
                        this.$inertia.get(route("orders.index"), {
                            'company': this.user.organization.id,
                        })
                        break;
