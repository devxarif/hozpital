                    ...
                    <div class="flex h-full flex-col bg-white shadow-xl">
                        <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                            ...
                            <form class="mb-4" @submit.prevent="saveData">
                                ...
                                <div class="mb-4">
                                    <Label :name="__('Image')" id="receptionist_create_image" :hasError="form.errors.image" :required="false"/>
...
export default {
    ...
    methods: {
        ...
        saveData() {
            this.form.post(route("admin.receptionist.store"), {
                onSuccess: () => {
                    this.form.reset(),
                    this.removeImage()
