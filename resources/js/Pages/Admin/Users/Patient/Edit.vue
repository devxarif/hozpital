                            ...
                            <form class="mb-4" @submit.prevent="saveData">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    <div class="mb-4">
                                        ...
                                        <Datepicker v-model="form.birth_date" :enableTimePicker="false" class="border-none bg-gray-50 border text-md rounded-lg block w-full p-1   "
...
export default {
    ...
    data() {
        return {
            ...
            previewImage: this.patient.avatar,
    ...
    methods: {
        ...
        saveData() {
            this.form.post(route("admin.patient.update", this.patient.id), {
                onSuccess: () => {
                    this.form.reset(),
                    this.removeImage()
