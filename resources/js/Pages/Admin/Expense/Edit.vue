    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                expense_category: this.expense.expense_category_id,
    ...
    watch: {
        expense: {
            handler() {
                ...
                this.form.expense_category = this.expense.expense_category_id
                this.form.invoice_number = this.expense.invoice_number
