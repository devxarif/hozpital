<template>
    ...
    <AppLayout>
       ...
       <!-- Card View  -->
       <template v-else-if="!loading && departments && departments.data.length && viewType == 'card'">
                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <table class="w-full divide-y divide-gray-300">
                            ...
                            <tr class="divide-x divide-gray-200">
                                <th width="20%" class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 sm:pl-6">Name</th>
                                <th width="10%" class="px-4 py-3.5 text-left text-sm font-semibold text-gray-900 break-words">Description</th>
                                <th width="5%" class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 sm:pr-6">Action</th>
                            </tr>
                            </thead>
                            ...
                            <tr class="divide-x divide-gray-200" v-for="i in 20" :key="i">
                                ...
                                <td class="whitespace-nowrap p-4 text-sm text-gray-500 break-all">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam hic voluptas voluptates sed laboriosam? Qui, doloribus eum nobis suscipit blanditiis voluptatibus quas quis cumque quisquam itaque, vel, dolorum quaerat maxime.
                                </td>
