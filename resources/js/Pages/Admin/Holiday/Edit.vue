                        ...
                        <div class="flex h-full flex-col bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                ...
                                <form class="mb-4" @submit.prevent="saveData">
                                    <div class="mb-4">
                                        <Label name="Title" id="holiday_title" :hasError="form.errors.title"/>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                color: this.holiday.color ?? '#ff0000',
            }),
    ...
    watch: {
        holiday: {
            handler() {
                this.form.title = this.holiday.title
                this.form.start = this.holiday.start
                this.form.end = this.holiday.end
                this.form.color = this.holiday.color ?? '#ff0000'
            },
            deep: true,
        },
    },
    methods: {
        saveData() {
            this.form.put(route("admin.holiday.update", this.holiday.id), {
                onSuccess: () => {
                    this.form.reset(),
