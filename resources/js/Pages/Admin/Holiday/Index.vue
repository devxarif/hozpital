<template>
    <AppLayout title="Holiday">

        <!-- Header Part  -->
        <Breadcrumb>
            <BreadcrumbLink title="Holiday"/>
        </Breadcrumb>
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <BaseButton @click="changeViewType" class="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 px-3 py-2">
