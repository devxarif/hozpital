                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                            ...
                            <h6 class="mb-2" v-if="organization.user">
                                {{ organization.user.name }}
                            </h6>
                            <h6 class="mb-2" v-if="organization.user"><a :href="`mailto:${organization.user.email}`">{{ organization.user.email }}</a></h6>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <h5 class="mb-3">{{ __('Company Details') }}</h5>
                            <h6 class="mb-2" v-if="organization.organization_name">{{ organization.organization_name }}</h6>
                            <p class="mb-1" v-if="organization.company_phone">{{ organization.company_phone }}</p>
                            <p class="mb-0" v-if="organization.organization_email"><a :href="`mailto:${organization.organization_email}`">{{ organization.organization_email }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
