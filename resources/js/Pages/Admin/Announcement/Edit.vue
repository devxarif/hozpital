                        ...
                        <div class="flex h-full flex-col bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <BaseInput v-model="form.title" placeholder="title" id="announcement_name" :hasError="form.errors.title"/>
                                </div>
                                <div class="mb-4">
    ...
    watch: {
        announcement: {
            handler() {
                ...
                this.form.type = this.announcement.type
