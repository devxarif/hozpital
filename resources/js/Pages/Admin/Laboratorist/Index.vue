    ...
    <AppLayout>
       ...
       <template v-else-if="!loading && laboratorists && laboratorists.data.length && viewType == 'card'">
            <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                <span v-for="laboratorist in laboratorists.data" :key="laboratorist.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100   ">
                    ...
                    <h2 class="text-2xl font-bold tracking-tight text-gray-900 ">{{ laboratorist.user?.name ?? '-' }}</h2>
