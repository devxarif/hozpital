<template>
    ...
    <AppLayout>
            ...
            <span v-for="pharmacist in pharmacists.data" :key="pharmacist.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div class="flex flex-wrap justify-between items-start">
                    <div class="relative mb-5">
                        <span>
                            <img class="w-16 h-16 rounded object-cover" alt="Figma logo" :src="pharmacist.avatar">
                        </span>
                    </div>
                    <div class="flex gap-2">
                        <button type="button" class="focus:outline-none" @click.prevent="editData(pharmacist)">
                        ...
                        <button type="button" class="focus:outline-none" @click.prevent="deleteData(pharmacist.id)">
        ...
        <Pagination :data="pharmacists" v-if="pharmacists && pharmacists.data.length" class="mt-5"/>
