<template>
    ...
    <AppLayout>
       ...
       <template v-else-if="!loading && pharmacists && pharmacists.data.length">
            ...
            <Pagination :data="pharmacists" v-if="pharmacists && pharmacists.data.length && pharmacists.data.length > 20" class="mt-5"/>
       </template>
