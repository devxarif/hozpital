    ...
    <AppLayout title="Income Category">
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <!-- Clear Filter -->
                <ClearFilter v-if="filter.keyword && filter.keyword.length"  :href="route('admin.incomeCategory.index')"/>
       ...
       <template v-else-if="!loading && income_categories && income_categories.data.length">
           ...
           <Pagination :data="income_categories" v-if="income_categories && income_categories.data.length && income_categories.total > app_setting.rows_per_page" class="mt-5"/>
       </template>
