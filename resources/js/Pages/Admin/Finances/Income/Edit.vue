                        ...
                        <div class="flex h-full flex-col bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                ...
                                <form class="mb-4" @submit.prevent="saveData">
                                    <div class="mb-4">
                                        <Label name="Income Category" id="income_category_name" :hasError="form.errors.income_category"/>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="mb-4">
                                            <Label name="Title" id="income_name" :hasError="form.errors.title"/>
                                            <BaseInput v-model="form.title" placeholder="Title" id="income_name" :hasError="form.errors.title"/>
                                        </div>
                                        <div class="mb-4">
                                            <Label name="Invoice Number" id="income_invoice_number" :hasError="form.errors.invoice_number" :required="false"/>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="mb-4">
                                            <Label name="Amount" id="income_amount" :hasError="form.errors.amount"/>
                                            <BaseInput v-model="form.amount" placeholder="Amount" id="income_amount" :hasError="form.errors.amount"/>
                                        </div>
                                        <div class="mb-4">
                                            <Label name="Date" id="income_date" :hasError="form.errors.date" :required="false"/>
