            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Accountant</a>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <span v-for="accountant in accountants.data" :key="accountant.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div class="flex flex-wrap justify-between items-start">
                    ...
                    <div class="flex gap-2">
                        <button type="button" class="focus:outline-none" @click.prevent="editData(accountant)">
                        ...
                        <button type="button" class="focus:outline-none" @click.prevent="deleteData(accountant.id)">
