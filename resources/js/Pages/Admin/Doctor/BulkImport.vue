    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto" v-click-outside="()=> $emit('close-modal')">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Doctor Bulk Import</h3>
                <form class="mb-4" @submit.prevent="saveData">
                    ...
                    <div class="my-4">
                        ...
                        <a href="/admin/dummy/doctor_example.xlsx" class="text-white justify-center flex items-center bg-blue-700 hover:bg-blue-800 w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mt-3">
                            <span>
                    ...
                    <div class="my-10">
                        ...
                        <div class="relative" v-if="previewDemoFile">
                            ...
                            <button @click="removeFile" type="button" class="absolute top-2 right-2 text-white bg-red-700 focus:ring-4 focus:ring-red-300 rounded-lg px-5 py-2.5 dark:bg-red-600 focus:outline-none dark:focus:ring-red-800">
...
export default {
    ...
    methods: {
        ...
        saveData() {
            this.form.post(route("admin.doctor.import"), {
                onSuccess: () => {
                    this.form.reset(),
                    this.removeFile()
