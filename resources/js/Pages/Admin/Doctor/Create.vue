...
<Transition name="slide-fade">
    <div class="fixed inset-0 overflow-hidden z-50" v-if="show">
        <div class="absolute inset-0 overflow-hidden transition-opacity">
            ...
            <div class="pointer-events-none absolute right-0 inset-y-0 flex max-w-2xl ltr:pl-10 rtl:pr-10">
...
<CreateDepartmentModal :show="showCreateDepartmentModal" @close-modal="showCreateDepartmentModal = false"/>
</template>
...
export default {
    ...
    methods: {
        ...
        showDepartmentModal() {
            ...
            // this.$emit('show-department-modal', this.isShowingDepartmentModal)
        },
        generatePassword(){
