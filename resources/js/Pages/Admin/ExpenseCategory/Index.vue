    ...
    <AppLayout>
       ...
       <template v-else-if="!loading && expense_categories && expense_categories.data.length">
           <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
               <span v-for="expense_category in expense_categories.data" :key="expense_category.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100   ">
                   <div class="flex flex-wrap justify-between items-start">
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{{ expense_category.name }}</h2>
                       <Menu as="div" class="relative inline-block text-left">
                           <div>
