<template>
    ...
    <AppLayout>
            ...
            <span v-for="patient in patients.data" :key="patient.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div class="flex flex-wrap justify-between items-start">
                    ...
                    <div class="flex gap-2">
                        <button type="button" class="focus:outline-none" @click.prevent="editData(patient)">
                        ...
                        <button type="button" class="focus:outline-none" @click.prevent="deleteData(patient.id)">
        ...
        <Pagination :data="patients" v-if="patients && patients.data.length" class="mt-5"/>
