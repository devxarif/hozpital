                ...
                <div class="overflow-x-auto -mx-4 -my-6 sm:-m-6">
                    <div class="align-middle inline-block min-w-full">
                        <div class="overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <template v-if="messages && messages.data.length">
                                        <tr class="relative hover:bg-slate-50" v-for="(message,index) in messages.data" :key="index">
                            ...
                            <Pagination :data="messages" v-if="messages && messages.data.length" />
                        </div>
        ...
        <div class="col-12">
            <div class="card mt-3">
                <div class="card-header">
                    ...
                    <Pagination :data="messages.links" />
                </div>
            </div>
        </div>
    </div> -->
