                ...
                <div class="overflow-x-auto -mx-4 -my-6 sm:-m-6">
                    <div class="align-middle inline-block min-w-full">
                        <div class="overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <template v-if="posts && posts.data.length">
                                        <tr class="relative hover:bg-slate-50" v-for="(post,index) in posts.data" :key="index">
                                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                <Link :href="route('posts.edit',post.id)">
                                                    <div class="flex items-center ">
                                                        <div class="mr-2">
                                                            <img class="w-6 h-6 rounded-full" :src="post.thumbnail" />
                                                        </div>
                            ...
                            <Pagination :data="orders" v-if="posts && posts.data.length" />
                        </div>
