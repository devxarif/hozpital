                    ...
                    <div class="pointer-events-auto w-screen max-w-xs lg:max-w-2xl">
                        <div class="flex h-full flex-col bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                ...
                                <div class="mb-4">
                                    <Label name="Image" id="productCategory_image" :hasError="form.errors.image" :required="false"/>
...
export default {
    ...
    data() {
        return {
            ...
            previewImage: this.category.image,
        };
    },
    watch: {
        category: {
    ...
    methods: {
        ...
        saveData() {
            this.form.post(route("pharmacist.productCategory.update", this.category.id), {
                onSuccess: () => {
                    this.form.reset(),
                    this.removeImage()
