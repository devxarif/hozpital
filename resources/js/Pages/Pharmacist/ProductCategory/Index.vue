    ...
    <AppLayout title="Product">
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <BaseButton v-if="filter.keyword && filter.keyword.length" as="link" :href="route('pharmacist.productCategory.index')" class="text-white bg-red-600 hover:bg-red-700 px-3 py-2">
...
export default {
    ...
    methods: {
        deleteData(id) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete(route("pharmacist.productCategory.destroy", id));
                }
            });
        },
        editData(department){
        ...
        filterData(){
            this.loading = true
            this.filterForm.get(route('pharmacist.productCategory.index'), {
                onSuccess: () => {
                    this.loading = false
                },
                onError: () => {
        ...
        toggleFilter() {
            ...
            localStorage.setItem("pharmacistDepartment", this.showFilter);
        },
    },
    created() {
        this.showFilter = localStorage.getItem("pharmacistDepartment") == "true" ? true: false;
    },
};
</script>
