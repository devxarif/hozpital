    ...
    <AppLayout title="Manufacture">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Manufacture</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <BaseButton v-if="filter.keyword" as="link" :href="route('pharmacist.manufacture.index')" class="text-white bg-red-600 hover:bg-red-700 px-3 py-2">
       ...
       <template v-else-if="!loading && manufactures && manufactures.data.length">
...
<script>
    ...
    export default {
        ...
        methods: {
            deleteData(id) {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.$inertia.delete(route("pharmacist.manufacture.destroy", id));
                    }
                });
            },
            ...
            filterData(){
                this.loading = true
                this.filterForm.get(route('pharmacist.manufacture.index'), {
                    onSuccess: () => {
                        this.loading = false
                    },
                    onError: () => {
            ...
            toggleFilter() {
                ...
                localStorage.setItem("pharmacistManufacture", this.showFilter);
            },
        },
        created() {
            this.showFilter = localStorage.getItem("pharmacistManufacture") == "true" ? true: false;
        },
    };
</script>
