    ...
    <AppLayout>
       ...
       <template v-else-if="!loading && manufactures && manufactures.data.length">
            <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                <span v-for="manufacture in manufactures.data" :key="manufacture.id" class="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <div class="flex flex-wrap justify-between items-start">
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ manufacture.name }}</h2>
