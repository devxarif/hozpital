    ...
    <AppLayout title="Patient">
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                ...
                <!-- Clear Filter -->
                <ClearFilter v-if="filter.keyword && filter.keyword.length"  :href="route('nurse.pharmacist.index')"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteData(id) {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.$inertia.delete(route("nurse.patient.destroy", id));
                    }
                });
            },
            editData(data){
            ...
            filterData(){
                this.loading = true
                this.filterForm.get(route('nurse.patient.index'), {
                    onSuccess: () => {
                        this.loading = false
                    },
                    onError: () => {
            ...
            toggleFilter() {
                ...
                localStorage.setItem("nursePatient", this.showFilter);
            },
        },
        created() {
