    ...
    <AppLayout>
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <BaseButton v-if="filter.keyword && filter.keyword.length" as="link" :href="route('nurse.bloodDonation.index')" class="text-white bg-red-600 hover:bg-red-700 px-3 py-2">
...
<script>
    ...
    export default {
        ...
        methods: {
            deleteData(id) {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.$inertia.delete(route("nurse.bloodDonation.destroy", id));
                    }
                });
            },
            ...
            filterData(){
                this.loading = true
                this.filterForm.get(route('nurse.bloodDonation.index'), {
                    onSuccess: () => {
                        this.loading = false
                    },
                    onError: () => {
            ...
            toggleFilter() {
                ...
                localStorage.setItem("nurseBloodDonation", this.showFilter);
            },
        },
        created() {
            this.showFilter = localStorage.getItem("nurseBloodDonation") == "true" ? true: false;
        },
    };
</script>
