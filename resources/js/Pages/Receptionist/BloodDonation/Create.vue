                            ...
                            <form class="mb-4" @submit.prevent="saveData">
                                <div class="mb-4">
                                    ...
                                    <BaseSelect v-model:value="form.blood_donor" :hasError="form.errors.blood_donor" class="w-3/2" id="donor_blood_donor" :showMessage="false">
                                        ...
                                        <option :value="donor.id" v-for="donor in donors" :key="donor.id">{{ donor.name }} - {{ donor.blood_group }}</option>
                                    </BaseSelect>
                                </div>
                                <div class="mb-4">
...
<script>
    export default {
        ...
        methods: {
            saveData() {
                this.form.post(route("receptionist.bloodDonation.store"), {
                    onSuccess: () => {
                        this.form.reset(),
