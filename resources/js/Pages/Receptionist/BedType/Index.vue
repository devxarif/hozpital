...
<script>
    ...
    export default {
        ...
        methods: {
            deleteData(id) {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.$inertia.delete(route("receptionist.bedType.destroy", id));
                    }
                });
            },
            editData(bed){
            ...
            filterData(){
                this.loading = true
                this.filterForm.get(route('receptionist.bedType.index'), {
                    onSuccess: () => {
                        this.loading = false
                    },
                    onError: () => {
            ...
            toggleFilter() {
                ...
                localStorage.setItem("receptionistBedType", this.showFilter);
            },
        },
        created() {
            this.showFilter = localStorage.getItem("receptionistBedType") == "true" ? true: false;
        },
    };
</script>
