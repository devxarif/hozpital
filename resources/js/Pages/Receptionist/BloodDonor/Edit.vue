                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="mb-4">
                                            ...
                                            <div class="flex gap-2">
                                                <label for="donor_male" class="w-full rounded-lg flex items-center pl-4 border border-gray-200 dark:border-gray-700   py-3 text-sm font-medium text-gray-700 gap-2">
                                                ...
                                                <label for="donor_female" class="w-full rounded-lg flex items-center pl-4 border border-gray-200 dark:border-gray-700 py-3 text-sm font-medium text-gray-700 gap-2">
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                gender: this.blood_donor.gender,
    ...
    watch: {
        blood_donor: {
            handler() {
                this.form.name = this.blood_donor.name,
                this.form.email = this.blood_donor.email,
                this.form.phone = this.blood_donor.phone,
                this.form.age = this.blood_donor.age,
                this.form.gender = this.blood_donor.gender,
                this.form.blood_group = this.blood_donor.blood_group,
                this.form.address = this.blood_donor.address
            },
            deep: true,
        },
    },
    methods: {
        saveData() {
            this.form.put(route("receptionist.bloodDonor.update", this.blood_donor.id), {
                onSuccess: () => {
                    this.form.reset(),
    ...
    mounted(){
        this.checkPagePermission('receptionist')
    }
};
</script>
