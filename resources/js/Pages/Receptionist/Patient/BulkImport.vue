    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto" v-click-outside="()=> $emit('close-modal')">
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 ">Patient Bulk Import</h3>
                <form class="mb-4" @submit.prevent="saveData">
                    ...
                    <div class="my-4">
                        ...
                        <a href="/assets/dummy/patient_example.xlsx" class="text-white justify-center flex items-center bg-blue-700 hover:bg-blue-800 w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 mb-2   focus:outline-none  mt-3">
                            <span>
...
export default {
    ...
    methods: {
        ...
        saveData() {
            this.form.post(route("receptionist.patient.import"), {
                onSuccess: () => {
                    this.form.reset(),
                    this.removeFile()
