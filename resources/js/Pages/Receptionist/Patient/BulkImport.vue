            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="mb-4" @submit.prevent="saveData">
                    ...
                    <div class="my-4">
                        ...
                        <a href="/admin/dummy/patient_example.xlsx" class="text-white justify-center flex items-center bg-blue-700 hover:bg-blue-800 w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 mb-2   focus:outline-none  mt-3">
                            <span>
