<template>
    <AppLayout title="Blood Donation">
        ...
        <!-- Header Part  -->
        <Breadcrumb>
            <BreadcrumbLink title="Blood Donation"/>
        </Breadcrumb>
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <!-- Clear Filter -->
                <ClearFilter v-if="filter.keyword && filter.keyword.length" :href="route('laboratorist.bloodDonation.index')"/>
       ...
       <template v-else-if="!loading && blood_donations && blood_donations.data.length">
            ...
            <Pagination :data="blood_donations" v-if="blood_donations && blood_donations.data.length && blood_donations.total > app_setting.rows_per_page" class="mt-5"/>
       </template>
