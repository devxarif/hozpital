                    ...
                    <div class="align-middle inline-block min-w-full">
                        <div class="shadow overflow-hidden">
                            <table class="table-fixed min-w-full divide-y">
                                    ...
                                    <tr>
                                        <th scope="col" class="p-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-all" type="checkbox" class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-200 h-4 w-4 rounded">
                                ...
                                <tbody class="">
                                    <tr class="hover:bg-gray-100" v-for="i in 20" :key="i">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
