<template>
    ...
    <div id="popover-user-profile" role="tooltip"
        ...
        <div style="position: absolute; left: 0px; transform: translate(0px, 0px);"></div>
    </div>
            ...
            <div class="flex-col md:flex-row flex items-center md:justify-center">
                ...
                <div class="relative mt-20 md:mt-0" @mouseover="showTooltip(1)" @mouseout="hideTooltip(1)">
                    ...
                    <div id="tooltip1" role="tooltip"
                        class="-mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-white p-4 rounded">
                        ...
                        <p class="text-xs leading-4 text-gray-600 pb-3 pt-2">Reach out to more prospects at the right
                            moment.</p>
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    class="focus:outline-none bg-blue-700 transition duration-150 ease-in-out hover:bg-blue-600 rounded text-white px-5 py-1 text-xs">Next</button>
                            </div>
                        </div>
                ...
                <div class="relative my-28 md:my-0 md:mx-64" @mouseover="showTooltip(2)" @mouseout="hideTooltip(2)">
                    ...
                    <div id="tooltip2" role="tooltip"
                        class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-blue-700 p-4 rounded">
                        <svg class="absolute left-0 -ml-2 bottom-0 top-0 h-full" width="9px" height="16px"
                            viewBox="0 0 9 16" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-blue-700 px-5 py-1 text-xs">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="tooltip3" role="tooltip"
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center">
                                <span class="text-xs text-white underline mr-2 cursor-pointer">Skip Tour</span>
                                <button
                                    class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-gray-600 px-5 py-1 text-xs">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
