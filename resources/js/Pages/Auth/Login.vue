            ...
            <div class="w-full bg-white rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="mt-1 grid grid-cols-5 gap-3">
                        <div>
                            <a href="/auth/facebook/redirect"
                                class="w-full inline-flex justify-center py-3 rounded-sm bg-[#f7f7f7] hover:bg-[#eeeded] text-sm font-medium">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="login">
                        ...
                        <button :disabled="form.processing" type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
