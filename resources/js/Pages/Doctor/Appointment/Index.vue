<template>
    <AppLayout title="Appointment">
        ...
        <!-- Header Part  -->
        <Breadcrumb>
            <BreadcrumbLink title="Appointment"/>
        </Breadcrumb>
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                ...
                <!-- Clear Filter -->
                <ClearFilter v-if="filter.keyword && filter.keyword.length" :href="route('admin.department.index')"/>
       ...
       <template v-else-if="!loading && appointments && appointments.data.length && viewType == 'card'">
        ...
        <!-- Table View  -->
        <BaseTable v-else-if="!loading && appointments && appointments.data.length && viewType == 'table'" :items="appointments">
