<template>
    <div class="mb-3">
        <h2 id="accordion-color-heading-1">
            <span type="button"
                class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-300 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400  dark:hover:bg-gray-800">
        ...
        <div id="accordion-color-body-1" v-show="enabled">
            <div class="p-5 font-light border border-b-0 border-gray-300 dark:border-gray-700 dark:bg-gray-900">
                <div>
