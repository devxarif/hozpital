    ...
    <AppLayout title="Blood Donor">
        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                <BaseButton v-if="filter.keyword || filter.gender || filter.blood_group" as="link" :href="route('doctor.bloodDonor.index')" class="text-white bg-red-600 hover:bg-red-700 px-3 py-2">
