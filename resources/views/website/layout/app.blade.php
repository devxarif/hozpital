...
<body>
    {{-- Preloader  --}}
    <div id="preloader" class="bg-white fixed top-0 bottom-0 left-0 right-0 z-50">
        <div id="preloaderInner" class="h-screen flex justify-center items-center">
            {{-- <img src="https://zaiwriteai.zainikthemes.com/storage/files/Setting/preloader-1677062474.png"> --}}
                    ...
                    <div class="flex h-16 items-center">
                        ...
                        <div class="ml-auto flex items-center">
                            <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                                ...
                                <a href="javascript:void(0)" class="text-sm font-medium text-gray-700 hover:text-gray-800">Create account</a>
                            </div>

                            <div class="hidden lg:ml-8 lg:flex">
                                <a href="javascript:void(0)" class="flex items-center text-gray-700 hover:text-gray-800">
                    ...
                    <div
                        ...
                        <div class="px-5 pt-5 pb-6">
                            ...
                            <div class="mt-6">
                                <nav class="grid gap-y-8">
                                    <a href="javascript:void(0)" class="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                        ...
                        <div class="space-y-6 py-6 px-5">
                            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                                <a href="javascript:void(0)" class="text-base font-medium text-gray-900 hover:text-gray-700">Pricing</a>
                                <a href="javascript:void(0)" class="text-base font-medium text-gray-900 hover:text-gray-700">Docs</a>
                                <div>
                                    <a href="javascript:void(0)"
                                    ...
                                    <p class="mt-6 text-center text-base font-medium text-gray-500">
                                        Existing customer?
                                        <a href="javascript:void(0)" class="text-blue-600 hover:text-blue-500">Sign in</a>
                                    </p>
                                </div>
                            </div>
                        </div>
