      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block text-center">
            ...
            <h1 class="text-capitalize mb-5 text-lg">{{ $department->name }}</h1>

            <ul class="list-inline breadcumb-nav">
              <li class="list-inline-item"><a href="{{ route('website.home') }}" class="text-white">Home</a></li>
              <li class="list-inline-item"><span class="text-white">/</span></li>
              <li class="list-inline-item"><a href="{{ route('website.department') }}" class="text-white">Department</a></li>
              <li class="list-inline-item"><span class="text-white">/</span></li>
              <li class="list-inline-item"><span class="text-white-50">{{ $department->name }}</span></li>
            </ul>
          </div>
        </div>
      </div>
