      ...
      <div class="col-lg-12 col-md-12 mb-5">
          <div class="blog-item">
              ...
              <div class="blog-item-content">
                  ...
                  <h2 class="mt-3 mb-3"><a href="{{ route('website.news.details') }}">Choose quality service over cheap service  all type of things</a></h2>
                  ...
                  <a href="{{ route('website.news.details') }}" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
              </div>
          </div>
      </div>
      ...
      <div class="col-lg-12 col-md-12 mb-5">
          <div class="blog-item">
              ...
              <div class="blog-item-content">
                  ...
                  <h2 class="mt-3 mb-3"><a href="{{ route('website.news.details') }}">All test cost 25% in always in our laboratory</a></h2>
      ...
      <div class="col-lg-12 col-md-12 mb-5">
          <div class="blog-item">
              ...
              <div class="blog-item-content">
                  ...
                  <h2 class="mt-3 mb-3"><a href="{{ route('website.news.details') }}">Get Free consulation from our special surgeon and doctors</a></h2>
