    ...
    <section aria-labelledby="products-heading" class="mt-6">
        ...
        <div class="space-y-8">
                    ...
                    <div class="sm:flex lg:col-span-7">
                        ...
                        <div class="mt-6 sm:mt-0 sm:ml-6">
                            ...
                            <p class="mt-3 text-sm text-gray-500">This durable and portable insulated tumbler will keep
                                your beverage at the perfect temperature during your next adventure.</p>
                        </div>
                    </div>
            ...
            <div class="border-t border-b border-gray-200 bg-white shadow-sm sm:rounded-lg sm:border">
                    ...
                    <div class="sm:flex lg:col-span-7">
                        ...
                        <div class="mt-6 sm:mt-0 sm:ml-6">
                            ...
                            <p class="mt-3 text-sm text-gray-500">This contemporary wristwatch has a clean, minimalist
                                look and high quality components.</p>
                        </div>
                    </div>
                ...
                <div class="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
                    <h4 class="sr-only">Status</h4>
                    <p class="text-sm font-medium text-gray-900">Shipped on <time datetime="2021-03-23">March 23,
                            2021</time></p>
                    <div class="mt-6" aria-hidden="true">
                        <div class="overflow-hidden rounded-full bg-gray-200">
