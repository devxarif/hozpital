        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-xl-7">
                <div class="block">
                    ...
                    <span class="text-uppercase text-sm letter-spacing">ENTIRE HOSPITAL SOLUTION</span>
                    <h1 class="mb-3 mt-3">Our strength is your well-being</h1>
                    ...
                    <div class="btn-container ">
                        <a href="{{ route('website.about') }}" class="btn btn-main-2">
                            Learn More
                        </a>
                        <a href="{{ route('website.contact') }}" class="btn btn-main">
                            Contact Us
                        </a>
                    </div>
                </div>
