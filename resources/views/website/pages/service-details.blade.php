        ...
        <div class="col-md-12">
          <div class="block text-center">
            ...
            <ul class="list-inline breadcumb-nav">
              ...
              <li class="list-inline-item"><a href="#" class="text-white-50">Service Details</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="department-img">
                      <img src="{{ asset('assets') }}/images/service/bg-1.jpg" alt="" class="img-fluid">
                  </div>
              </div>
          </div>
          ...
          <div class="row">
              <div class="col-lg-8">
                  <div class="department-content mt-5">
                      ...
                      <a href="{{ route('website.appointment') }}" class="btn btn-main-2 btn-round-full">Make an Appoinment<i class="icofont-simple-right ml-2  "></i></a>
                  </div>
              </div>
