...
<div class="-mt-[5.75rem] pt-[5.75rem]"><img src="/img/beams-basic.png" alt=""
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-24">
            <h1 class="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Terms & Condition</h1>
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div
            ...
            <p>This privacy policy ("Policy") describes how Tailwind Labs Inc. ("Tailwind", "we", "us" or "our")
                ...
                ("User", "you" or "your") may provide through the Tailwind UI website (tailwindui.com) or in the course
                of purchasing any Tailwind UI products (collectively, "Website"). The Policy also describes the choices
            ...
            <p>We receive and store any information you knowingly provide to us when you make a purchase through the
                ...
                to the Website and access any purchased Tailwind UI products.</p>
            ...
            <p>All purchases made through the Website are processed by a third party payment processor, Paddle (<a
                ...
                collection and use of personal information. Tailwind does not control Paddle or its collection or use of
            ...
            <p>You are able to update your Personal Information in your "Account Settings" on the Website. Currently
                ...
                email address, but this will prevent you from accessing the products you have purchased from Tailwind.
            </p>
            ...
            <p>You may exercise certain rights regarding your information processed by us. In particular, you have the
                ...
                based on your consent, on a contract which you are part of or on pre-contractual obligations thereof.
            </p>
            ...
            <p>Any requests to exercise User rights can be directed to the Owner by email at <a
                    href="mailto:support@tailwindui.com">support@tailwindui.com</a>. These requests can be exercised
                free of charge and will be addressed by the Owner as early as possible and always within one month.</p>
            <h2>Privacy of children</h2>
            <p>We do not knowingly collect any Personal Information from children under the age of 13. If you are under
                the age of 13, please do not submit any Personal Information through our Website. We encourage parents
            ...
            <h2>Newsletters</h2>
            <p>We offer electronic newsletters which you may voluntarily subscribe to. You may choose to stop receiving
                our newsletter or marketing emails by following the unsubscribe instructions included in these emails or
            ...
            <p>Our Website contains links to other websites that are not owned or controlled by us. Please be aware that
                we are not responsible for the privacy practices of such other websites or third parties. We encourage
                you to be aware when you leave our Website and to read the privacy statements of each and every website
            ...
            <p>If you have any questions about this Policy, please contact us by email at <a
                    href="mailto:support@tailwindui.com">support@tailwindui.com</a>.</p>
        </div>
    </div>
</div>
@endsection
