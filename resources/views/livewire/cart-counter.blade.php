<div class="ml-4 flow-root lg:ml-6 relative" x-data="{open:false}">
    <a @click="open = !open" href="javascript:void(0)" class="group -m-2 flex items-center p-2">
        ...
        <div class="px-4 mt-px pb-6">
            ...
            <ul role="list" class="divide-y divide-gray-200">
                @foreach ($cart_items as $item)
                    <li class="py-2 flex">
                        <img src="{{ $item->attributes['image'] }}"alt="Insulated Travel Mug 18 Oz." class="flex-none w-16 rounded-md border border-gray-200 object-cover">
