<html lang="en" class="h-full"><head>
    ...
    <title>Oops! Something went wrong. Please try again</title>
    ...
    <link href="https://snop.me/public/css/app.css" rel="stylesheet">
    <link href="https://snop.me/public/css/style.css" rel="stylesheet">
    ...
    <div class="bg-white">
        ...
        <footer class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
            <p class="text-base text-gray-400">{{ $setting->app_copyright }}</p>
            <div class="mt-6 flex justify-center space-x-8 md:mt-0">
              <a href="javascript:void(0)" class="inline-flex text-gray-400 hover:text-gray-500">
