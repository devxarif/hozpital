...
class LeaveTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia('Organization/LeaveType/Index', [
    ...
    {
        return inertia('Organization/LeaveType/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $leave_type = $organization->leaveTypes()->create([
            'name' => $request->name,
            'color' => $request->color,
    ...
    public function edit(LeaveType $leaveType)
    {
        ...
        return inertia('Organization/LeaveType/Edit', [
            'leaveType' => $leaveType,
        ]);
    }
