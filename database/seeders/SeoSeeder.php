    ...
    public function run()
    {
        $pages = [
            [
                'page_name' => 'Home',
                'page_slug' => 'home',
                'title' => 'Welcome To Hozpital - The Best Way To Leave',
                'description' => 'Hozpital is leave management system that helps you to manage your leave and get the best leave management system for your business.',
