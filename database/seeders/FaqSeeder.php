    ...
    public function run()
    {
        $faqs = [
            ...
            [
                ...
                'answer' => "You can easily create your team, open the app, choose “create a team”, add your organization name, email, and password and choose the country, then press “sign up”. Afterward, you can set the organization working days, add leave types then start adding employees."
            ],
            [
                'question' => "How can I set the organization settings?",
                'answer' => "After creating the organization's account, you can choose the working days, types of leaves and balances as well as customizing the employees view.Then visit the setting tabs from sidebar."
            ],
            [
            ...
            [
                ...
                'answer' => "After creating the organization’s account, you need to go employees page from sidebar then you can invite employees or create a employee instantly"
            ],
            [
